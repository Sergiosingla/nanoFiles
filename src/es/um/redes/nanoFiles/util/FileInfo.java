...
public class FileInfo {
	...
	public static FileInfo[] fromString(String str) {
		...
		for (String line : lines) {
			...
			fileInfoList.add(new FileInfo(hash, name, size, null)); // Assuming filePath is not needed here
		}
	...
	public boolean equals(Object obj) {
		...
		return fileHash.equals(other.fileHash);
	}
}
